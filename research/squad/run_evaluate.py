...
def main():
    ...
    if args.no_cuda:
        model.load_state_dict(torch.load('/heavy_data/jkfirst/workspace/git/publish/research/squad/squad_model.bin', map_location='cpu'))
    else:
        model.load_state_dict(torch.load('/heavy_data/jkfirst/workspace/git/publish/research/squad/squad_model.bin'))
    model.eval()
